...
export default function BrandingModal({ onClose }) {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      onClose()
      // Full reload so the new image is picked up everywhere it's referenced
      // (favicon link, sidebar, login page) instead of threading refresh state through each.
  ...
  return (
    <Modal title="Configure" onClose={onClose}>
        ...
        <div className="modal-body">
          <div className="form-group">
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
              ...
              >
                <img
                  src={preview || '/api/v1/branding/image'}
                  alt="Current logo"
              ...
              <div>
                ...
                {file && (
                  <div style={{ fontSize: 12, color: 'var(--text-muted)', marginTop: 6 }}>{file.name}</div>
                )}
              </div>
            </div>
          </div>
